...
Today, most LLMs support structured output
...
documentation of your chosen model
...
| `aparse_result` | Async parse a list of candidate model `Generation` objects into a specific format. |
...
#### ``pydantic\_object`class-attribute``instance-attribute`¶
...
#### ``return\_id`class-attribute``instance-attribute`¶
...
#### ``first\_tool\_only`class-attribute``instance-attribute`¶
...
BaseOutputParser BaseLLMOutputParser RunnableSerializable Serializable Runnable
...
<code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>            <span class="doc doc-object-name doc-class-name">BaseLLMOutputParser</span> (<code>langchain_core.output_parsers.BaseLLMOutputParser</code>)")
