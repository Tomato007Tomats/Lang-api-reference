...
## ``langchain\_tests.integration\_tests.ChatModelIntegrationTests ¶
...
| `test_json_mode` | Test structured output via JSON mode.. |
...
### ``test\_tool\_calling\_async`async`¶
...
### ``test\_structured\_output\_async`async`¶
...
### ``invoke\_with\_reasoning\_output ¶
...
### ``invoke\_with\_cache\_read\_input ¶
...
### ``invoke\_with\_cache\_creation\_input ¶
